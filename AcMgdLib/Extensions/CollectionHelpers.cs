...
namespace Autodesk.AutoCAD.DatabaseServices.Extensions
{
   ...
   public static partial class DatabaseExtensions
   {
      ...
      public static bool IsValid(this Database db, bool checkContents = false)
      {
         if(db == null || db.IsDisposed || db.IsBeingDestroyed
               || db.UnmanagedObject == IntPtr.Zero)
            return false;
         return true; //  ! checkContents || db.BlockTableId.IsValid;
      }
      ...
      public static ObjectId GetRecordId(this SymbolTable table, string key)
      {
