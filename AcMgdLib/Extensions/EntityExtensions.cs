...
namespace Autodesk.AutoCAD.DatabaseServices.Extensions
{
   ...
   /// Linq-consumable extension methods to perform common 
   ...
   public static partial class EntityExtensions
   {
      ...
      public static IEnumerable<int> Explode(
         this IEnumerable<Entity> entities,
         DBObjectCollection output,
         bool erase = false)
      {
      ...
      /// were prodoced by exploding it using the index.
         ...
         foreach(var entity in entities)
         {
            ...
            catch(Autodesk.AutoCAD.Runtime.Exception ex)
            {
               if(ex.ErrorStatus != AcRx.ErrorStatus.NotApplicable
                  && ex.ErrorStatus != AcRx.ErrorStatus.CannotExplodeEntity)
                  throw ex;
               list.Add(0);
               continue;
            }
      ...
      public static IEnumerable<T> TransformBy<T>(this IEnumerable<T> source,
         Matrix3d matrix)
         where T : Entity
      {
      ...
      /// <summary>
      /// Uses deferred execution, and requires the result to 
      /// be enumerated. 
      /// 
      /// Usually the result is fed to the Append() method of 
      /// DatabaseTransaction which enumerates its argument.
      /// </summary>
      /// <param name="entities"></param>
      ...
      {
         Assert.IsNotNullOrDisposed(entities);
      ...
      public static IEnumerable<Entity> SetPropertiesFrom(this IEnumerable<Entity> entities, Entity source)
      {
         ...
         Assert.IsNotNullOrDisposed(source);
