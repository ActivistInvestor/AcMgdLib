...
namespace Autodesk.AutoCAD.Runtime
{
   ...
   public static partial class RuntimeExtensions
   {
      ...
      /// <summary>
      /// Throws an exception if the given AsLispObjectId does not
      ...
      ///    
      /// throws an exception if the AsLispObjectId does not represent
      ...
      ///    
      /// If the given AsLispObjectId is null, the ErrorStatus will be
      /// ErrorStatus.NullObjectId, rather than the ErrorStatus
      /// which the method is invoked through.
      /// 
      /// This method can be used to both validate an AsLispObjectId as 
      ...
      /// AsLispObjectId must represent an instance of</typeparam>
      /// <param name="es">The ErrorStatus to pass to the Exception</param>
      /// <param name="id">The AsLispObjectId to validate</param>
      /// <param name="exact">A value indicating if the AsLispObjectId can
      ...
      /// <summary>
      /// This method is planned but not implmented.
      /// It performs ErrorStatus-specific validation.
      /// </summary>

      public static bool Validate(this AcRx.ErrorStatus es, DBObject obj)
      {
         switch(es)
         {
            case ErrorStatus.NotOpenForWrite: return obj.IsWriteEnabled;
         }
         return true;
      }
   ...
   public static partial class RXClass<T> where T : RXObject
   {
      ...
      public static RXClass MyParent => Value.MyParent;
      ...
      /// <param name="exactMatch">A value indicating if the
      /// type of the DBObject represented by an AsLispObjectId must 
      ...
      /// </summary>
      /// <param name="id">The AsLispObjectId whose runtime class is to be 
      ...
      /// <summary>
      /// Returns a predicate function that takes an AsLispObjectId
      /// as an argument and returns a value indicating if the
      /// AsLispObjectId argument represents a DBObject whose managed
      ...
      /// <returns>A predicate that when passed an AsLispObjectId returns
      /// a value indicating if the AsLispObjectId matches the criteria</returns>
      ...
      /// are overloads that test the ObjectClass of an AsLispObjectId,
      /// and overloads that test an RXClass.
      /// 
      /// Note: No check is performed on the AsLispObjectId argument
