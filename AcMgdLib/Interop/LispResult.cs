...
namespace Autodesk.AutoCAD.Runtime.LispInterop
{
   ...
   /// TypedValues to a ResultBuffer also has a cost. 
   /// 
   ...
   public class LispResult : CachedEnumerable<TypedValue>
   {
      ResultBuffer value;

      public LispResult(IEnumerable<TypedValue> source)
         : base(source)
      {
      ...
      public static implicit operator ResultBuffer(LispResult operand)
      {
