...
namespace Autodesk.AutoCAD.Runtime.LispInterop
{
   ...
   ///   
   /// See the included InteropTests.cs for more detail.
   /// </summary>
   ...
   public static class ListBuilder
   {
      ...
      /// used to create a ResultBuffer that can be passed
      ...
      /// <summary>
      /// A counterpart of the LISP (cons) function.
      /// 
         ...
         int depth = 0)
      {
         ...
         while(e.MoveNext())
         {
            ...
            throw new ArgumentException($"Unsupported type ({argtype}): {argstr}");
