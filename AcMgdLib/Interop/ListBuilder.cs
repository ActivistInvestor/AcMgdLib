...
namespace Autodesk.AutoCAD.Runtime.LispInterop
{
   ...
   public static class ListBuilder
   {
      ...
      public static readonly TypedValue[] EmptyList = 
         new[] { ListBegin, ListEnd };

      public static readonly ResultBuffer EmptyResult =
         new ResultBuffer(EmptyList);
      ...
      public static TypedValue ToTypedValue(this object arg, LispDataType type = LispDataType.None, bool throwIfNotFound = false)
      {
         if(arg == null)
