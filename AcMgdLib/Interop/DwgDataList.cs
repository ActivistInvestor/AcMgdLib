...
namespace Autodesk.AutoCAD.DatabaseServices.Extensions
{
   ...
   public class DwgDataList : DwgFiler, IReadOnlyCollection<DwgDataItem>
   {
      ...
      /// 
      /// For example, to get the 3rd AsLispPoint3d in the list:
      /// 
      ///   dwgDataList.OfTypeAt(DwgDataType.AsLispPoint3d, 2);
      ///   
      /// </summary>
      ...
      /// 
      /// For example, to get the 3rd AsLispPoint3d value that was 
      /// filed out by the DBObject, you would use:
      /// <code>
      /// 
      ///    AsLispPoint3d thirdPoint;
      ///    if(myDwgDataList.TryGetValueAt(DwgDataType.AsLispPoint3d, 3, out thirdPoint))
      ///    {
   ...
   public struct DwgDataItem : IEquatable<DwgDataItem>
   {
      ...
      /// 
      /// E.g., the first AsLispPoint3d written out will have a 
      /// TypeIndex of 0. The second AsLispPoint3d written out 
