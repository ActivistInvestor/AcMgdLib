...
namespace Autodesk.AutoCAD.Runtime.LispInterop
{
   ...
   public abstract class TypedValueConverter
   {
      ...
      /// <summary>
      /// If the argument is true, the method should
      /// indicate if a conversion to one or more
      /// TypedValues is supported. If the argument is
      /// false, the method should indicate if a
      /// conversion from StringBuilder to one or more 
