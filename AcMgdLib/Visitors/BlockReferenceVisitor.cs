...
namespace Autodesk.AutoCAD.DatabaseServices.Extensions
{
   ...
   public abstract class BlockReferenceVisitor 
   {
      dynamic dynamicThis;
      ...
      public BlockReferenceVisitor(bool exactMatch = false, 
      ...
      /// of nesting which the owning BlockReference is visited at.
      /// 
      ...
      /// public bool VisitXrefOverlay { get; set; }
      ...
      public FullSubentityPath GetFullSubEntityPath(Entity entity)
      {
         ...
         Assert.MustBeTrue(array[array.Length - 1].IsNull);
         array[array.Length - 1] = entity.ObjectId;
         return new FullSubentityPath(array, nullSubEntityId);
      }
      ...
      /// </summary>
      /// <returns>A FullSubentityPath that can be passed to
      /// PopHighlight to unhighlight the entity.</returns>
