...
namespace Autodesk.AutoCAD.DatabaseServices.Extensions
{
      ...
      where T : Entity
   {
      ...
      /// is deferred until the instance is requested through 
      ...
      {
         base.Push(blkref);
         context.Push(new Cached<TContext, BlockReference>(
            blkref, GetContext, true));
      }
      ...
      /// <summary>
      /// Overridden because instances of this type 
      /// cannot must be contextual.
      /// </summary>
