...
namespace Autodesk.AutoCAD.DatabaseServices
{
   ...
   /// one of the ObjectOverrule overrides. Doing that will 
   /// crash AutoCAD.
   /// </summary>
   ...
   public abstract class ObjectOverrule<T> : ObjectOverrule where T : DBObject
   {
      ...
      /// virtual method of the ObjectOverrule base type.
      /// </summary>
      ...
      /// any virtual method of the ObjectOverrule base type. 
      ...
      bool isOverrule
      {
         get
         {
            return this.GetType().GetMethods(BindingFlags.Public | BindingFlags.Instance)
               .Any(m => m.IsVirtual && m.GetBaseDefinition().DeclaringType == typeof(ObjectOverrule)
                  && m.DeclaringType != typeof(ObjectOverrule));
         }
      }
