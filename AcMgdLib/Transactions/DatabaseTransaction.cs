...
namespace Autodesk.AutoCAD.DatabaseServices.Extensions
{
   ...
   public class DatabaseTransaction : Transaction
   {
      ...
      public static DatabaseTransaction OpenDwgFile(string path, FileOpenMode mode,
      ...
      public ObjectIdCollection Append(IEnumerable<Entity> entities, BlockTableRecord owner = null, bool disposeOnFail = true)
      {
         CheckDisposed();
      ...
      public ObjectIdCollection Append<T>(DBObjectCollection<T> entities, bool dispose = true) where T: Entity
      {
         return Append(entities.OfType<Entity>(), CurrentSpaceForWrite, dispose);
      }
