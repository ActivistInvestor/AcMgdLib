...
namespace System.Linq.Expressions.Predicates.Examples
{
   ...
   public static class FilterExample
   {
      ...
      public static void Run()
      {
         ...
         /// The above call to Add() modifies filter2,
         /// but leaves filter1 as it was.
         /// 
         /// After the call to Add(), the delegate 
         /// generated by filter2 becomes:
         /// 
         ///   arg => arg < 10 && arg > 5
         ///
         ...
         /// filters that can use instance data to determine
         /// the result of their predicates.
         /// 
