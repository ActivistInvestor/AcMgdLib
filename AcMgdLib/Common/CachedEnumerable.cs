...
namespace System.Collections.Generic.Extensions
{
   ...
   /// wrapped IEnumerable<T>'s result is constant across
   /// multiple enumerations (iow, every enumeration will
   ...
   public class CachedEnumerable<T> : CachedEnumerable, IEnumerable<T>
   {
      ...
      {
         return CachePolicy == CachePolicy.Lazy ? (IEnumerator<T>) new LazyEnumerator(this) : new Enumerator(this);
      }
