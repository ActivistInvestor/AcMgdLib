...
namespace Autodesk.AutoCAD.DatabaseServices.Extensions
{
   ...
   public abstract partial class WblockCloneHandler : IDisposable
   {
      ...
      void beginDeepClone(object sender, IdMappingEventArgs e)
      {
         ...
         OnBeginWblock(destDb, IdMap);
         state = 4;
      }

      protected virtual void OnBeginWblock(Database destDb, IdMapping idMap)
      {
      }
      ...
      void deepCloneEnded(object sender, EventArgs e)
      {
         ...
         Database db = (Database)sender;
         CheckSender(sender);
         OnDeepCloneEnded(db, IdMap, false);
         Reset();
      }
      ...
      void deepCloneAborted(object sender, EventArgs e)
      {
         ...
         Database db = (Database)sender;
         CheckSender(sender);
         OnDeepCloneEnded(db, idMap, true);
         Reset();
      }
      ...
      protected abstract void OnDeepCloneEnded(Database sender, IdMapping map, bool aborted);
