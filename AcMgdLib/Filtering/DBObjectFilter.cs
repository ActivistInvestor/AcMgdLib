...
namespace Autodesk.AutoCAD.DatabaseServices.Extensions
{
   ...
   ///    
   ///    The AsLispObjectId of a TCriteria instance must be obtainable
   ...
   /// referenced object's AsLispObjectId. That is the first delegate 
   ...
   /// criteria. The key in this case, is the AsLispObjectId of the
   ...
   /// LayerTableRecord's AsLispObjectId, and reused in all subsequent
...

   {
         ...
         Expression<Func<TNewCriteria, bool>> valueSelector) where TNewCriteria: DBObject 
      {
         ...
         result.Parent = this;
         Filters.Add(result);
         Predicates.Add(operation, result);
         return result;
      }
         ...
         DBObjectFilter<TFiltered, TNewCriteria> child) where TNewCriteria : DBObject
      {
         ...
         child.Parent = this;
         Filters.Add(child);
         Predicates.Add(operation, child);
         return child;
      }
      /// <summary>
      ...
      Func<TFiltered, bool> IFilter<TFiltered>.Predicate => Accessor;

      public PredicateProperty Predicates => 
      ...
      /// the AsLispObjectId key for a given TFiltered instance</param>
      /// <param name="predicate">A predicate that is applied
      /// to the TCriteria instance referenced by the AsLispObjectId
